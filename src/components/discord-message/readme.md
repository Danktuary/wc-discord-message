...
| `avatar`    | `avatar`     | The message author's avatar. Can be a relative path or external link.                                                         | `string`         | `undefined`  |
...
| `profile`   | `profile`    | The profile data to use.                                                                                                      | `string`         | `undefined`  |
...
| `timestamp` | `timestamp`  | The timestamp to use for the message date. When supplying a string, the format must be `01/31/2000`.                          | `Date \| string` | `new Date()` |
